...
There are total 845 observations in the combined dataset, the key variables include date, weight_tons, volume_cubic_yards, plastic_bottles, and wrappers. The total weight of trash collected by Professor Trash Wheel is 216.26 tons. There total number of cigarette butts collected by Gwynda in June of 2022 are 18,120.
